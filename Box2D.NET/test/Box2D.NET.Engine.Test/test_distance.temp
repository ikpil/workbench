...
public class test_distance : test_macros
{
    public void SegmentDistanceTest()
    {
        ...
        ENSURE_SMALL( result.fraction1 - 0.5f, float.Epsilon );
        ENSURE_SMALL( result.fraction2 - 1.0f, float.Epsilon );
        ENSURE_SMALL( result.closest1.x + 1.0f, float.Epsilon );
        ENSURE_SMALL( result.closest1.y, float.Epsilon );
        ENSURE_SMALL( result.closest2.x - 1.0f, float.Epsilon );
        ENSURE_SMALL( result.closest2.y, float.Epsilon );
        ENSURE_SMALL( result.distanceSquared - 4.0f, float.Epsilon );
    }
    ...
    public void ShapeDistanceTest()
    {
        ...
        ENSURE_SMALL( output.distance - 1.0f, float.Epsilon );
    }
