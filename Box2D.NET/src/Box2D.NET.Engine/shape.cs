...
public static b2ShapeId b2CreateCapsuleShape( b2BodyId bodyId, b2ShapeDef def, b2Capsule capsule )
{
	...
	if ( lengthSqr <= B2_LINEAR_SLOP * B2_LINEAR_SLOP )
    {
		...
		return b2CreateShape( bodyId, def, circle, Engine.b2ShapeType.b2_circleShape );
	}

	return b2CreateShape( bodyId, def, capsule, Engine.b2ShapeType.b2_capsuleShape );
}
...
public static b2ShapeId b2CreatePolygonShape( b2BodyId bodyId, b2ShapeDef def, b2Polygon polygon )
{
	...
	return b2CreateShape( bodyId, def, polygon, Engine.b2ShapeType.b2_polygonShape );
}
...
public static b2ShapeId b2CreateSegmentShape( b2BodyId bodyId, b2ShapeDef def, b2Segment segment )
{
	...
	return b2CreateShape( bodyId, def, segment, Engine.b2ShapeType.b2_segmentShape );
}
...
void b2Shape_SetCircle( b2ShapeId shapeId, const b2Circle* circle )
{
	...
	b2Shape* shape = b2GetShape( world, shapeId );
	shape.circle = *circle;
	shape.type = Engine.b2ShapeType.b2_circleShape;
...
void b2Shape_SetCapsule( b2ShapeId shapeId, const b2Capsule* capsule )
{
	...
	shape.type = Engine.b2ShapeType.b2_capsuleShape;
...
void b2Shape_SetSegment( b2ShapeId shapeId, const b2Segment* segment )
{
	...
	shape.type = Engine.b2ShapeType.b2_segmentShape;
...
void b2Shape_SetPolygon( b2ShapeId shapeId, const b2Polygon* polygon )
{
	...
	shape.type = Engine.b2ShapeType.b2_polygonShape;
