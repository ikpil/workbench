...
using jdk.jfr.FlightRecorder;
using org.jctools.queues.MpmcArrayQueue;
using org.jctools.queues.MpscArrayQueue;
using org.jctools.queues.MpscChunkedArrayQueue;
using org.jctools.queues.MpscUnboundedArrayQueue;
using org.jctools.queues.SpscLinkedQueue;
using org.jctools.queues.atomic.MpmcAtomicArrayQueue;
using org.jctools.queues.atomic.MpscAtomicArrayQueue;
using org.jctools.queues.atomic.MpscChunkedAtomicArrayQueue;
using org.jctools.queues.atomic.MpscUnboundedAtomicArrayQueue;
using org.jctools.queues.atomic.SpscLinkedAtomicQueue;
using org.jctools.queues.atomic.unpadded.MpscAtomicUnpaddedArrayQueue;
using org.jctools.queues.unpadded.MpscUnpaddedArrayQueue;
using org.jctools.util.Pow2;
using org.jctools.util.UnsafeAccess;
...
using static Netty.NET.Common.Util.Internal.PlatformDependent0.HASH_CODE_ASCII_SEED;
using static Netty.NET.Common.Util.Internal.PlatformDependent0.HASH_CODE_C1;
using static Netty.NET.Common.Util.Internal.PlatformDependent0.HASH_CODE_C2;
using static Netty.NET.Common.Util.Internal.PlatformDependent0.hashCodeAsciiSanitize;
using static Netty.NET.Common.Util.Internal.PlatformDependent0.unalignedAccess;
...
public sealed class PlatformDependent {
    ...
    /**
     * namespace private for testing purposes only!
     */
