...
using static Netty.NET.Common.Util.Internal.InternalThreadLocalMap.UNSET;
using static Netty.NET.Common.Util.Internal.InternalThreadLocalMap.VARIABLES_TO_REMOVE_INDEX;
