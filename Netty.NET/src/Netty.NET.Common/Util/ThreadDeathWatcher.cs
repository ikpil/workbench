...
using Netty.NET.Common.Util.concurrent.DefaultThreadFactory;
...
using java.util.concurrent.ConcurrentLinkedQueue;
...
public final class ThreadDeathWatcher {
     ...
     */
    public static bool awaitInactivity(long timeout, TimeUnit unit) throws InterruptedException {
